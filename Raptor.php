...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Libra 2.0.php" style="color: #fff;">&lt; Anterior</a>
        <span>|</span>
        <a href="Stealth X.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/controles/Raptor.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Raptor</h2>
