...
<div class="container">
        <form action="formulario Clientes.php" method="POST">
            ...
            <div class="privacy-policy">
                ...
                <label for="politica_privacidade" >Eu concordo com a <a style="padding-left: 5px; color:blueviolet" href="Política de Privacidade.php">política de privacidade</></label>
</div>
