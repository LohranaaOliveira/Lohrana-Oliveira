...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Cyber Kid Infinite.php" style="color: #fff;">&lt; Anterior </a>
        <span>|</span>
        <a href="Kira and the Fading Islands.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/games/dead-at-last.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Dead at Last</h2>
        <p class="product-price">Preço: <s>R$ 179,99</s> R$ 161,99</p>
