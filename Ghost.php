...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Flint.php" style="color: #fff;">&lt; Anterior</a>
        <span>|</span>
        <a href="Libra 2.0.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/controles/Ghost.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Ghost</h2>
