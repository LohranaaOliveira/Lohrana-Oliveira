...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Raptor.php" style="color: #fff;">&lt; Anterior</a>
        <span>|</span>
        <a href="Wave.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/controles/Stealth X.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Stealth X</h2>
