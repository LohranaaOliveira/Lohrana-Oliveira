...
<head>
    ...
    <title>Mouse Wireless Blaze</title>
...
<div class="navigation">
        <div class="navigation-left">
            ...
            <span>|</span>
            <a>Mouse Wireless Blaze</a>
        </div>
        <div class="navigation-right">
            <a href="Mouse Wireless X2.php" style="color: #fff;">&lt; Anterior</a>
            <span>|</span>
            <a href="Teclado Mecânico CO-21.php" style="color: #fff;">Próximo &gt;</a>
        </div>
    ...
    <div class="produto">
        <div class="container3">
            <div class="left-side">
                <img src="produtosimg/acessorios/Mouse Wireless Blaze.webp" alt="Product Image">
            ...
            <div class="right-side">
                <h2 class="product-title">Mouse Wireless Blaze</h2>
                <p class="product-price">Preço: R$ 124,99</p>
