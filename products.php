...
if (isset($_POST['search'])) {
  // Captura a consulta de pesquisa e filtra os produtos
  ...
  <div class="search-bar">
    <form action="" method="POST">
      <input type="text" name="search_query" placeholder="Pesquisar produtos..." required>
...
<div class="image-container1-wrapper">
  <div class="image-container-row" id="productContainer">
    ...
    if (mysqli_num_rows($select_products) > 0) {
      ...
      while ($fetch_product = mysqli_fetch_assoc($select_products)) {
        if ($product_count % 3 == 0 && $product_count != 0) {
          echo '</div><div class="image-container-row">';
        }
    ?>
    ...
    <?php
      ...
      echo '<p>Nenhum produto encontrado para sua pesquisa.</p>';
    }
    ?>
  </div>
</div>
