...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Ghost.php" style="color: #fff;">&lt; Anterior</a>
        <span>|</span>
        <a href="Raptor.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/controles/Libra 2.0.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Libra 2.0</h2>
        <p class="product-price">Preço: R$ 149,99</p>
