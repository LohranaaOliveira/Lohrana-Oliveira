...
<div class="navigation">
    ...
    <div class="navigation-right">
        <a href="Ancient Souls.php" style="color: #fff;">&lt; Anterior </a>
        <span>|</span>
        <a href="Cyber Kid Infinite.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/games/chronosplit.webp" alt="Product Image">
      ...
      <div class="right-side">
        <h2 class="product-title">Chronosplit</h2>
