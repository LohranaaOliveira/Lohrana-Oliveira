...
<head>
    ...
    <title>Teclado Mecânico Spartan</title>
...
<body>
  ...
  <div class="navigation">
    <div class="navigation-left">
      ...
      <span>|</span>
      <a>Teclado Mecânico Spartan</a>
    </div>
    <div class="navigation-right">
      <a href="Teclado Mecânico CO-21.php" style="color: #fff;">&lt; Anterior</a>
      <span>|</span>
      <a>Próximo &gt;</a>
    </div>
  ...
  <div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/acessorios/teclado-mecanico-spartan.webp" alt="Product Image">
        <p>O Teclado Mecânico Spartan oferece um desempenho excepcional e uma experiência de digitação agradável.
      ...
      <div class="right-side">
        <h2 class="product-title">Teclado Mecânico Spartan</h2>
        <p class="product-price"><s>R$ 220,99</s> R$ 198,89</p>
