...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Bairro</span>
            <input type="text" placeholder="Digite o Bairro" name="bairro" required>
         </div>
         <div class="inputBox">
            <span>Endereço</span>
            <input type="text" placeholder="Digite o Endereço" name="endereco" required>
         </div>
...
<script>
   document.getElementById('telefone').addEventListener('input', function (e) {
        ...
        const citiesByState = {
            'SC': ['Blumenal', 'Florianópolis',],
            'PA': ['Belém', 'Ponta de pedras',],
            'GO': ['Anápolis', 'Águas lindas de Goiás',],
            'CE': ['Fortaleza', 'Itapipoca',],
            'AM': ['Manaus', 'Boca do acre',],
            'BA': ['Salvador', 'Vitória da conquista', 'Alagoinhas', 'Xique-Xique',],
