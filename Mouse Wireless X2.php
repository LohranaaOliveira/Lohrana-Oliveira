...
<div class="navigation">
        <div class="navigation-left">
            ...
            <span>|</span>
            <a>Mouse Wireless X2</a>
        </div>
        <div class="navigation-right">
            <a href="headset L503.php" style="color: #fff;">&lt; Anterior</a>
            <span>|</span>
            <a href="Mouse Wireless Blaze.php" style="color: #fff;">Próximo &gt;</a>
        </div>
    ...
    <div class="produto">
        <div class="container3">
            <div class="left-side">
                <img src="produtosimg/acessorios/mause-wirelessX2.webp" alt="Product Image">
            ...
            <div class="right-side">
                <h2 class="product-title">Mouse Wireless X2</h2>
