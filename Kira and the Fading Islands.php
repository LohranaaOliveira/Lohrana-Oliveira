...
<head>
    ...
    <title>Kira and the Fading Islands</title>
...
<div class="navigation">
    <div class="navigation-left">
        ...
        <span>|</span>
        <a>Kira and the Fading Islands</a>
    </div>
    <div class="navigation-right">
        <a href="dead at last.php" style="color: #fff;">&lt; Anterior </a>
        <span>|</span>
        <a href="Ice Dome Exile.php" style="color: #fff;">Próximo &gt;</a>
    </div>
...
<div class="produto">
    <div class="container3">
      <div class="left-side">
        <img src="produtosimg/games/Kira and the Fading Islands.webp" alt="Product Image">
        <p>Sou uma descrição do produto. Este é um ótimo lugar para "vender" seu produto e chamar a atenção dos visitantes. Descreva seu produto de forma clara e concisa, use palavras-chave exclusivas e mostre seu diferencial.</p>
      </div>
      <div class="right-side">
        <h2 class="product-title">Kira and the Fading Islands</h2>
        <p class="product-price">Preço: <s>R$ 199,99</s> R$ 179,99</p>
        ...
        <p class="product-info">Informações do produto:
          <p>Estes são os detalhes do produto. Use este espaço para adicionar informações, como cor, tamanho, material, instruções e mais. Este também é um ótimo lugar para escrever o que torna este produto especial e como seus clientes podem se beneficiar deste item. Os clientes gostam de saber o que estão recebendo antes de comprar, portanto, forneça o máximo de informações possível para que possam comprar com confiança.</p>
        </p>
      </div>
    </div>
</div>
